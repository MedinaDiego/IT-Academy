...
class Tigger
{
    ...
    // Añadimos el modificador de acceso a la función CLONE que nos permite clonar un objeto. Ya que solo queremos instanciar a traves de la funcion getInstance. 
